...
## v2.1.1 focus: Trail Mode Simplification

v2.1.1 responds to real trail-use feedback. The app now does less while the user is outside. The Muse screen becomes the main hiking surface: start the walk, save one sentence, expose a prompt, or open one of four useful capture cards. Everything else can wait until later review on a PC.
...
- Updated visible version to **FI-077 · v2.1.1**.

## Design intent

Trail Muse should not compete with the hike. The v2.1.1 outdoor workflow is designed around a simple principle:
...
Field Instrument 077 · Trail Muse v2.1.1
